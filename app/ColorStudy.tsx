  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {tab === "targets" && <section className="guide-page">
        ...
        <p className="guide-note"><strong>Still underrepresented:</strong> original European Ice Age painting, early medieval northern Europe, the wider Caribbean, many Pacific islands, Central America, and South America beyond the Andes. <a href="/photo-search.md">See the region and era coverage review ↗</a></p>
