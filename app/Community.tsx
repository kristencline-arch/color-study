    ...
    <div className="contribution-layout">
      ...
      <form className="contribution-form" onSubmit={publish}>
        <fieldset disabled={publishing}>
          ...
          <label>What should someone look for? <span className="optional">Optional</span><textarea name="description" maxLength={1200} rows={3} placeholder="Describe the textile or painted surface, its date if known, lighting or conservation work." /></label>
