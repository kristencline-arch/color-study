  ...
  return <div className="showcase-page">
    ...
    <section className="selected-studies" aria-labelledby="selected-heading">
      ...
      <div className="showcase-grid">{selections.map((item, index) => {
        ...
        return <article className={`showcase-card ${["marble-sphinx", "met-324017", "commons-scarlet-ware-6", "commons-gunda-gunde-5r", "cma-135486", "cma-119685", "cma-150680", "cma-102957", "commons-tonga-ngatu", "cma-144924", "cma-129796", "cma-111312"].includes(item.id) ? "sculpture-card" : ""}`} key={item.id}>
