...
const demonstrations = [
  ...
  {"id": "commons-beni-hassan-19", "label": "Beni Hassan", "place": "Amenemhat tomb · Egypt", "detail": "Small figures across a worn wall.", "note": "Rows of figures and painted bands survive under uneven artificial light. Open the guided details to compare them with cracks and bright reflections."},
  {"id": "commons-oplontis-wall-2", "label": "Oplontis", "place": "Villa A · Oplontis, Italy", "detail": "Fine lines on pale plaster.", "note": "Faint painted ornaments survive among surface losses. Inspect a single motif at native resolution while keeping the original alongside it."},
  {"id": "commons-faras-archangel", "label": "Nubia", "place": "Faras · present-day Sudan", "detail": "Ornament in a surviving fragment.", "note": "Repeated patterns remain on a detached Nubian mural. Guided details distinguish the surviving painted edge from the large areas of loss."},
  {"id": "commons-pazyryk-carpet", "label": "Pazyryk textile", "place": "Pazyryk · Altai Mountains", "detail": "Color carried in thousands of knots.", "note": "Figures and rosettes remain in an ancient wool carpet. Inspect the worn weave and the photograph’s strong color rendition without treating false color as an identification of dyes."},
  ...
  {id: "commons-altxerri-big-bison", label: "Ice Age", place: "Altxerri B · Basque Country, Spain", detail: "A bison in faint red lines.", note: "Red pigment survives across the original cave surface. Compare the contours with cracks, deposits and uneven light. False color cannot date the painting or restore its original hues."},
  {id: "commons-castelseprio-joseph", label: "Early medieval", place: "Castelseprio · Italy · c. 830–950, debated", detail: "A dream on a worn wall.", note: "The scene of Joseph’s dream preserves delicate strokes and patches of color. The painting’s date is debated; the comparison separates recorded colors without reconstructing the missing plaster."},
  ...
  {id: "commons-palmettes-flowers", label: "Macedonia", place: "Tomb of the Palmettes · Mieza, Greece", detail: "Flowers above an ancient doorway.", note: "Palmettes and water lilies survive on the painted vault. Compare the worn passages with the remaining blue ground; changes in lighting and conservation treatments also affect the photograph."},
  {id: "commons-gunda-gunde-5r", label: "Manuscript", place: "Gunda Gunde Gospels · Ethiopia · 16th century", detail: "Color between the lines.", note: "Painted ornament frames a page written in Gǝʿǝz. Compare the colored ink, parchment and worn margins. The enhancement changes their separation, not the words or the historical palette."},
  {id: "cma-144924", label: "Europe", place: "Painted limestone · Paris? · c. 1400", detail: "Color survives in the folds.", note: "This limestone Virgin and Child retains polychromy and gilding. Compare the painted drapery with exposed stone. Museum lighting, wear and conservation also shape the colors in the photograph."},
  {id: "commons-fontein-6", label: "Caribbean", place: "Fontein Cave · Aruba", detail: "Painted lines across limestone.", note: "Indigenous pictographs survive on the cave surface. Compare the red passages with the surrounding rock. The cave also has later graffiti; this photograph does not establish the age of every mark."},
  {id: "commons-tonga-ngatu", label: "Pacific Islands", place: "Ko e kalauni ngatu · Tonga · 1900–1940", detail: "A story painted on barkcloth.", note: "A crown, lettering and borders remain on this historic ngatu. Follow the brown painted lines across the pale barkcloth; the changed colors are a photographic study, not the cloth’s original palette."},
];
...
const selections = [
  ...
  {id: "commons-altxerri-big-bison", title: "An Ice Age bison, in red.", place: "Altxerri B · Basque Country, Spain", description: "A large painted animal spans the original cave wall. Follow the faint red contours beside mineral deposits and cracks."},
  {id: "commons-durrow-125v", title: "Interlace across a page.", place: "Book of Durrow · c. 700", description: "A detailed library scan preserves painted geometry, worn pigment and the texture of parchment. Explore the full-resolution page in the lab."},
  {id: "commons-castelseprio-joseph", title: "A dream, still in color.", place: "Castelseprio · Italy · early medieval", description: "Faded figures survive in Joseph’s dream. The fresco cycle’s date remains debated; its losses and conservation history matter to the study."},
  {id: "commons-bernifal-9", title: "A painted sign in the cave.", place: "Bernifal · Dordogne, France", description: "Small red marks form a tectiform sign on the original surface. Compare pigment with mineral color and the uneven cave lighting."},
  {id: "cma-114201", title: "Gold ink on purple parchment.", place: "Carolingian gradual · c. 830–860", description: "A worn manuscript bifolium retains metallic writing on dyed parchment. Inspect faint letters alongside folds and changes in the support."},
  {id: "commons-prokulus-28", title: "Faces on an Alpine wall.", place: "St Proculus · Naturns, Italy", description: "Early medieval figures remain in fine painted outlines. Compare the light strokes with the pale ground and repaired plaster."},
  {id: "commons-taull-01", title: "Faces on a surviving fragment.", place: "Sant Climent de Taüll · Catalonia · c. 1123", description: "Romanesque wall painting transferred to canvas. Compare the remaining figures with worn paint, joins and losses."},
  {id: "commons-fontein-6", title: "Lines left on a cave wall.", place: "Fontein Cave · Aruba", description: "Indigenous painted motifs across a limestone surface. The cave’s later marks and varied lighting remain part of the photograph."},
  {id: "commons-tonga-ngatu", title: "A crown on barkcloth.", place: "Tonga · 1900–1940", description: "Painted borders and lettering surround a crown. Study the brown pattern beside folds and the texture of the barkcloth."},
  {id: "cma-144924", title: "The painted folds of stone.", place: "Paris? · c. 1400", description: "A limestone sculpture with surviving polychromy and gilding. Look closely at the faded robes and exposed stone."},
  {id: "cma-129796", title: "Faint figures on parchment.", place: "England · c. 1325–1350", description: "A leaf from a psalter preserves the Annunciation in delicate color. Compare the painted figures with the aging support."},
  {id: "cma-111312", title: "Woven color, worn with time.", place: "Italy, possibly Florence · 1450–1500", description: "Two-color velvet and gold form a curved lattice. Compare surviving red and green with changes in the pile and lighting."},
  {id: "commons-akrotiri-spring", title: "Spring on an ancient wall.", place: "Akrotiri · Bronze Age Aegean", description: "Painted lilies and birds survive in assembled fresco fragments. Keep the joins and conservation history in view."},
  {id: "commons-maravillas-2", title: "A closer view of Taíno painting.", place: "Cueva de las Maravillas · Dominican Republic", description: "Dark painted figures on a cave surface, photographed under warm light. Compare contours while retaining the original beside the color study."},
  {id: "commons-palmettes-flowers", title: "A ceiling in bloom.", place: "Mieza · Macedonia, Greece", description: "Ancient flowers and tendrils across a tomb vault. Compare a faded petal with the surviving painted ground."},
  {id: "commons-gunda-gunde-5r", title: "A page full of color.", place: "Gunda Gunde · Ethiopia", description: "Painted ornament and colored writing on parchment from a sixteenth-century Gospel book."},
  {id: "cma-135486", title: "A small fragment, still vivid.", place: "Western Tibet or Kashmir · 12th century", description: "A painted Maitreya on a manuscript fragment. Look closely at the red ground, worn edges and surviving figure."},
  {id: "cma-119685", title: "A face painted into cloth.", place: "Paracas · Peru · 400–200 BCE", description: "A painted cotton textile from a funerary bundle. Follow the faint features across the weave and folds."},
  {id: "cma-150680", title: "A kangaroo on bark.", place: "Western Arnhem Land · Australia · 20th century", description: "Painted lines follow the animal’s body across a bark support. The museum’s regional attribution and date remain with the photograph."},
  {id: "cma-102957", title: "Color on a carved raven.", place: "Haida · Northwest Coast", description: "Red, dark and blue-green painted passages on a historic wooden rattle. Keep highlights and the display background outside the fitted area."},
  {id: "commons-agios-left-detail", title: "The guard beside the door.", place: "Agios Athanasios · Macedonia, Greece", description: "A close view of a painted guard from an ancient Macedonian tomb. Compare the worn clothing, contours and plaster losses."},
  ...
  return <div className="showcase-page">
    <section className="showcase-hero" aria-labelledby="showcase-title">
      <div className="hero-copy">
        ...
        <p className="hero-description">Explore painted scrolls, dyed textiles, worn murals and once-painted marble through color separation. Start with a remarkable photograph, or bring your own.</p>
      ...
      <figure className="hero-study">
        ...
        <div className={`hero-comparison ${["marble-sphinx", "cma-294034", "met-324017", "commons-gunda-gunde-5r", "cma-144924", "commons-tonga-ngatu", "commons-beni-hassan-19", "commons-faras-archangel", "commons-pazyryk-carpet"].includes(demo.id) ? "sculpture-comparison" : ""}`} style={{"--split": `${split}%`} as CSSProperties}>
    ...
    <section className="collection-discovery" aria-labelledby="collection-heading">
      <div className="section-heading"><div><p className="eyebrow">{sources.length} PHOTOGRAPHS / OPEN TO EXPLORE</p><h2 id="collection-heading">Follow the color.<br /><em>Choose a collection.</em></h2></div><p>Egyptian tombs, Pompeian rooms, European manuscripts, Caribbean cave paintings and Pacific barkcloth. Explore by place or material, with each photograph’s dates and cultural context close at hand.</p></div>
    ...
    <section className="selected-studies" aria-labelledby="selected-heading">
      ...
      <div className="showcase-grid">{selections.map((item, index) => {
        ...
        return <article className={`showcase-card ${["commons-durrow-125v", "cma-114201", "marble-sphinx", "met-324017", "commons-scarlet-ware-6", "commons-gunda-gunde-5r", "cma-135486", "cma-119685", "cma-150680", "cma-102957", "commons-tonga-ngatu", "cma-144924", "cma-129796", "cma-111312"].includes(item.id) ? "sculpture-card" : ""}`} key={item.id}>
