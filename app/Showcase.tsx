  ...
  return <div className="showcase-page">
    <section className="showcase-hero" aria-labelledby="showcase-title">
      ...
      <figure className="hero-study">
        ...
        <div className={`hero-comparison ${["marble-sphinx", "cma-294034", "met-324017", "commons-gunda-gunde-5r", "cma-144924", "commons-tonga-ngatu"].includes(demo.id) ? "sculpture-comparison" : ""}`} style={{"--split": `${split}%`} as CSSProperties}>
