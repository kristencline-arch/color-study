  ...
  return <div className="showcase-page">
    <section className="showcase-hero" aria-labelledby="showcase-title">
      ...
      <figure className="hero-study">
        ...
        <div className={`hero-comparison ${["marble-sphinx", "cma-294034", "met-324017", "commons-gunda-gunde-5r"].includes(demo.id) ? "sculpture-comparison" : ""}`} style={{"--split": `${split}%`} as CSSProperties}>
    ...
    <section className="collection-discovery" aria-labelledby="collection-heading">
      <div className="section-heading"><div><p className="eyebrow">{sources.length} PHOTOGRAPHS / OPEN TO EXPLORE</p><h2 id="collection-heading">Follow the color.<br /><em>Choose a collection.</em></h2></div><p>From Egyptian tombs and Pompeii to Ethiopian manuscripts, Asian scrolls, Pacific barkcloth and Indigenous painted works. Explore by place or material, with each photograph’s dates and cultural context close at hand.</p></div>
    ...
    <section className="selected-studies" aria-labelledby="selected-heading">
      ...
      <div className="showcase-grid">{selections.map((item, index) => {
        ...
        return <article className={`showcase-card ${["marble-sphinx", "met-324017", "commons-scarlet-ware-6", "commons-gunda-gunde-5r", "cma-135486", "cma-119685", "cma-150680", "cma-102957"].includes(item.id) ? "sculpture-card" : ""}`} key={item.id}>
